...
package STM32F407.RNG is
   ...
   subtype CR_RNGEN_Field is STM32F407.Bit;
   subtype CR_IE_Field is STM32F407.Bit;
   ...
   subtype SR_DRDY_Field is STM32F407.Bit;
   subtype SR_CECS_Field is STM32F407.Bit;
   subtype SR_SECS_Field is STM32F407.Bit;
   subtype SR_CEIS_Field is STM32F407.Bit;
   subtype SR_SEIS_Field is STM32F407.Bit;
